    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.submit_btn).setOnClickListener {
            ...
            if (photoFile != null){
                ...
                Log.e(TAG, "Error: no photo attached!")
                Toast.makeText(this, "Please attach a picture", Toast.LENGTH_SHORT).show()
            }
        ...
        findViewById<Button>(R.id.takePicture_btn).setOnClickListener {
            onLaunchCamera()
        }
    ...
    fun submitPost(description:String, user: ParseUser, photoFile:File){
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Log.i(TAG, "Successfully submitted post!")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                val ivPreview: ImageView = findViewById(R.id.post_img)
